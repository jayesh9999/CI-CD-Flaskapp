pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = "jayesh9999/mental_health_assistant:new"
        DOCKER_BUILDKIT = '1'
    }
    ...
    stages {
        stage('Git Checkout') {
            steps {
                git branch: 'new', credentialsId: 'githubtoken', url: 'https://github.com/jayesh9999/mental-health-chatbot-devops-pipeline.git'
            }
        }
            ...
            steps {
                script {
                    withDockerRegistry( credentialsId: 'dockerhubcred', url: '') {
                        sh "docker pull jayesh9999/mental_health_assistant:new || true"
